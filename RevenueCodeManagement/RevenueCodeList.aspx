<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Site1.Master" AutoEventWireup="true" CodeBehind="RevenueCodeList.aspx.cs" Inherits="NCGDSasp.Admin.RevenueCodeManagement.RevenueCodeList" %>
				                    ...
				                    <div class="panel-body">
				                        <div class="col-xs-12" id="manageUserTable">
                                            ...
                                            <asp:ListView ID="lvRevCode" runat="server" OnDataBound="lvRevCode_DataBound"
                                                OnPagePropertiesChanging="lvRevCode_PagePropertiesChanging" DataKeyNames="RevenueCodeID"  >

<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Site1.Master" AutoEventWireup="true" CodeBehind="EditUser.aspx.cs" Inherits="NCGDSasp.Admin.UserManagement.EditUser" EnableEventValidation="false" %>
				                                ...
				                                <div class="col-xs-12">
				                                    ...
				                                    <div class="col-xs-4">
				                                        ...
				                                        <div class="col-xs-8">
				                                               ...
				                                               <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:NGCDSConnectionString %>" SelectCommand="SELECT * FROM [HomeAgency]"></asp:SqlDataSource>
				                                ...
				                                <div class="col-xs-12">
				                                    <div class="col-xs-4">
				                                        ...
				                                        <div class="col-xs-8">
				                                                ...
				                                                <asp:SqlDataSource ID="dsRevenueCode" runat="server" ConnectionString="<%$ ConnectionStrings:NGCDSConnectionString %>" SelectCommand="SELECT * FROM [RevenueCode]"></asp:SqlDataSource>
				                                ...
				                                <div class="col-xs-12">
				                                    <div class="col-xs-4">
				                                        ...
				                                        <div class="col-xs-8">
				                                               ...
				                                               <asp:SqlDataSource ID="dsFundSource" runat="server" ConnectionString="<%$ ConnectionStrings:NGCDSConnectionString %>" SelectCommand="SELECT * FROM [FundSource]"></asp:SqlDataSource>
				                                           <br />
				                                        </div>
				                                    </div>
				                                </div>
				                                ...
				                                <div class="col-xs-12">
				                                    ...
				                                    <div class="col-xs-4">
				                                        ...
				                                        <div class="col-xs-8">
                                                            ...
                                                            <asp:Button ID="btnSubmit" class="btn btn-default saveUser" runat="server" Text="Submit" OnClick="btnSubmit_Click" />
				                                        </div>
				                                    </div>
				                                </div>
				                            </div>

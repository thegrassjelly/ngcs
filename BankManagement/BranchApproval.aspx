<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Site1.Master" AutoEventWireup="true" CodeBehind="BranchApproval.aspx.cs" Inherits="NCGDSasp.Admin.BankManagement.BranchApproval" %>
				                    ...
				                    <div class="panel-body">
				                        <div class="col-xs-12" id="manageUserTable">
                                            ...
                                            <asp:ListView ID="lvBankBranch" runat="server" OnDataBound="lvBankBranch_DataBound"
                                                OnPagePropertiesChanging="lvBankBranch_PagePropertiesChanging" DataKeyNames="bankbranchID" onItemCommand="lvBankBranch_ItemCommand" >
                                                ...
                                                <ItemTemplate>
                                                   ...
                                                   <td><%# Eval("regionname") %></td>
                                                    <td><%# Eval("Remarks") %></td>
                                                          ...
                                                          <td>
                                                            <a href='EditBank.aspx?ID=<%# Eval("bankbranchID") %>'>

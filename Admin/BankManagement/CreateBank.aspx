<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Site1.Master" AutoEventWireup="true" CodeBehind="CreateBank.aspx.cs" Inherits="NCGDSasp.Admin.BankManagement.CreateBank" %>
				                       ...
				                       <br />
				                            ...
				                            <div class="form-group">
				                                <div class="col-xs-12">
				                                    <div class="col-xs-4">
				                                        <div class="col-xs-4">
				                                            <label for="cBankUacs">Bank UACS Code:</label>
				                                        </div>
				                                        <div class="col-xs-8">
				                                                   <asp:TextBox ID="txtBankUACS" class="form-control" runat="server"></asp:TextBox>

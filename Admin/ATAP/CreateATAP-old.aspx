<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Site1.Master" AutoEventWireup="true" CodeBehind="CreateATAP-old.aspx.cs" Inherits="NCGDSasp.Admin.ATAP.CreateATAPold" enableEventValidation="false" %>
		...
		<div class="container-fluid">
			<section class="content-header">
				...
				<ol class="breadcrumb">
					...
					<li class="active">Create ATAP | number</li>
				</ol>
			</section>
				                ...
				                <form id="createAtapForm">
				                	<div class="col-xs-12 col-sm-6 form-horizontal">
				                		<div class="form-group">
									  	...
									  	<div class="form-group">
									    	...
									    	<div class="col-sm-8">
                                                    <asp:TextBox ID="txtAddress" class="form-control" runat="server" placeholder="Ex. Cagayan de Oro City, Philippines"></asp:TextBox>
									  	...
									  	<div class="form-group">
									    	...
									    	<div class="col-sm-8">
									             ...
									             <asp:TextBox ID="txtTo" class="form-control" runat="server"  placeholder="Ex. Dan Walker"></asp:TextBox>
		                                        	</div>
									  	</div>
									  	<div class="form-group">
									    ...
									    <div class="form-group">
									    	...
									    	<div class="col-sm-8">
									    	             ...
									    	             <asp:TextBox ID="txtAgencyAddress" class="form-control" runat="server"></asp:TextBox>
		                                       </div>
									    </div>
				                	</div>
				                	<div class="col-xs-12 col-sm-6 form-horizontal">
				                		<div class="form-group">
									    	...
									    	<div class="col-sm-8">
                                                              <asp:TextBox ID="txtAmountOfBond" class="form-control" runat="server"  placeholder="Ex. 1000" ReadOnly></asp:TextBox>
				                		...
				                		<div class="form-group">
									    	...
									    	<div class="col-sm-8">
									    		<div class="input-group date">
                                                                       <asp:TextBox ID="txtDatePrepared"  class="form-control pull-right" runat="server" type="date" ></asp:TextBox>
									    ...
									    <div class="form-group">
									    	...
									    	<div class="col-sm-8">
                                                   ...
                                                   <asp:TextBox ID="txtAmountPayable"  class="form-control" runat="server"  placeholder="Ex. 1000" readonly></asp:TextBox>
									    ...
									    <div class="form-group">
									    	...
									    	<div class="col-sm-8">
									    	  <asp:TextBox ID="txtApprovedBy"  class="form-control" runat="server" placeholder="Ex. Dan Walker" ></asp:TextBox>
				                	...
				                	<div class="col-xs-12 text-right">
				                		<hr>
                                            ...
                                            <asp:Button ID="btnCompute"  class="btn btn-sm btn-default bondBtn" runat="server" Text="Compute Bond Premium" />
				                	...
				                	<div class="col-xs-12">
				                		...
				                		<table class="table table-striped table-bordered">
                                            ...
                                            <asp:ListView ID="lvFundSource" runat="server" OnDataBound="lvFundSource_DataBound"
                                                OnPagePropertiesChanging="lvFundSource_PagePropertiesChanging" DataKeyNames="ATAPDetailsID" OnItemCommand="lvFundSource_ItemCommand"   >
                                       
                                                <ItemTemplate>
                                                    <tr>
                                                           <asp:Literal ID="ltATAPDetailsID" runat="server" Text='<%# Eval("ATAPDetailsID") %>' Visible="false" />
                                                    
                                                        <td><%# Eval("Name") %></td>   
                                                        <td><%# Eval("Station") %></td>
                                                           <td><%# Eval("RiskNo") %></td>

                                                         <td><%# Eval("ApprovedAmountofBond","{0: #,###.00}") %></td>
                                                        <td><%# Eval("BondingDate") %></td>
		                            ...
		                            <div class="col-xs-12 text-right">
                                        ...
                                        <asp:Button ID="btnSubmit" class="btn btn-primary" runat="server" Text="Submit for Confirmation" />
		                            </div>
		                        </form>
				            </div>
				        </div>
	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
				...
				<div class="row">
					...
					<div class="col-xs-12 col-sm-6 form-horizontal">
						<div class="form-group">
					    	...
					    	<div class="col-sm-7">
					    		<input type="text" id="riskNumber" class="form-control" value="<?php echo $_SESSION['cMLIDAtap']; ?>" placeholder="1231" />
					    	</div>
					    </div>
					</div>
					<div class="col-xs-12">
			...
			<div class="modal-footer text-right">
                    ...
                    <asp:Button ID="btnSubmitBond" class="btn btn-primary" runat="server" Text="Submit" OnClick="btnSubmitBond_Click" />
        ...
        <script>
            $(document).ready(function() {
                ...
                $('#submitOfficerData').click(function () {
                    ...
                    $('.officer-data').each(function () {
                        officerData.push({
                            type: $(this).find('.acountability').val(),
                    ...
                    $.ajax({
                        url: '../functions/add-atap-officer-data.php',
                        method: 'POST',
                        data: params,
                        dataType: 'json',
                        success: function() {
                ...
                $('#addConfirmationButton').click(function() {
                    ...
                    file.append('atap_no', atapNo);	
                    file.append('address', address);	
                    file.append('to', to);	
                    file.append('agency', agency);	
                    file.append('agency_code', agencyCode);	
                    file.append('amount_of_bond', amountOfBond);	
                    file.append('date_prepared', datePrepared);	
                    file.append('total_amount_payable', totalAmountPayable);	
                    file.append('approved_by', approvedBy);	
                    file.append('file', attachment[0]);	

                    $.ajax({
                        url: "../functions/create-atap.php",
                        type: "POST",
                        data: file,
                        processData: false,
                        dataType: "json",
                        ...
                        success: function(data) {
                            window.location.href = "manage-atap-confirmation.php";
                        }
                    })
                });
            });

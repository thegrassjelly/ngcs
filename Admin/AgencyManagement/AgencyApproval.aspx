<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Site1.Master" AutoEventWireup="true" CodeBehind="AgencyApproval.aspx.cs" Inherits="NCGDSasp.Admin.AgencyManagement.AgencyApproval" %>
				                    ...
				                    <div class="panel-body">
				                        <div class="col-xs-12" id="manageUserTable">
                                            ...
                                            <asp:ListView ID="lvAgency" runat="server" OnDataBound="lvAgency_DataBound"
                                                OnPagePropertiesChanging="lvAgency_PagePropertiesChanging" DataKeyNames="AgencyID" onItemCommand="lvAgency_ItemCommand"  >

<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Site1.Master" AutoEventWireup="true" CodeBehind="UserList.aspx.cs" Inherits="NCGDSasp.Admin.UserManagement.UserList" %>
				                    ...
				                    <div class="panel-body">
				                        <div class="col-xs-12" id="manageUserTable">
                                            ...
                                            <asp:ListView ID="lvUsers" runat="server" OnDataBound="lvUsers_DataBound"
                                                OnPagePropertiesChanging="lvUsers_PagePropertiesChanging" DataKeyNames="UserID"  >

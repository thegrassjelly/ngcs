<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Site1.Master"  ClientIDMode="AutoID" AutoEventWireup="true" CodeBehind="ViewLDC.aspx.cs" Inherits="NCGDSasp.Admin.Endorsement.ViewLDC" EnableEventValidation="false" %>
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="col-md-6">
                                                                ...
                                                                <div class="col-md-8">
                                                                    ...
                                                                    <asp:DropDownList ID="ddlType" runat="server" class="form-control" CssClass="form-control" Enabled="false"
                                                >
                                                            ...
                                                            <div class="col-md-6">
                                                                ...
                                                                <div class="col-md-8">
                                                                    <div class="input-group date">
                                                                     <asp:TextBox ID="txtCreationDate" runat="server" class="form-control" type="date" required CssClass="form-control" Enabled="false" />
                                                                    </div>
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="col-md-6">
                                                                ...
                                                                <div class="col-md-8">
                                                                   ...
                                                                   <asp:DropDownList ID="ddlbanks" runat="server" CssClass="form-control" Enabled="false" class="form-control" OnSelectedIndexChanged="ddlbanks_SelectedIndexChanged" AutoPostBack="True" DataSourceID="SqlDataSource1" DataTextField="BankName" DataValueField="BankID">
                                                            ...
                                                            <test id="bankBranchDropdown">
                                                                <div class="col-md-6">
                                                                    ...
                                                                    <div class="col-md-8">
                                                                               ...
                                                                               <asp:DropDownList ID="ddlBranch" runat="server" class="form-control" AutoPostBack="True" CssClass="form-control" Enabled="false"
                                                >
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="col-md-6">
                                                                ...
                                                                <div class="col-md-8">
                                                                    <div class="input-group date">
                                                                   <asp:TextBox ID="txtCollectionDate" runat="server" class="form-control" type="date" required CssClass="form-control" Enabled="false" />
                                                            ...
                                                            <div class="col-md-6">
                                                                ...
                                                                <div class="col-md-8">
                                                                    <div class="input-group date">
                                                                         <asp:TextBox ID="txtDepositDate" runat="server" class="form-control" type="date" required CssClass="form-control" Enabled="false"/>
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="col-md-6">
                                                                ...
                                                                <div class="col-md-8">
                                                                    <div class="input-group date">
                                                                           <asp:TextBox ID="txtCreditedDate" runat="server" class="form-control" type="date" required CssClass="form-control" Enabled="false"/>
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="col-md-6">
                                                                ...
                                                                <div class="col-md-8">
                                                                    <asp:TextBox ID="txtClearing" runat="server" class="form-control" required CssClass="form-control" Enabled="false"/>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="col-md-4">
                                                                ...
                                                                <div class="col-md-8">
                                                                  <asp:TextBox ID="txtRemark" runat="server" class="form-control"  required CssClass="form-control" Enabled="false" />
                                                                       <br /><br />
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-xs-12">
                                                            <div class="pull-right">
                                                                ...
                                                                <!--<a href="../reports/html/rptTR_LDChtml.php" class="btn btn-default">Preview </a>-->
                                                                      <asp:Button ID="btndraft" runat="server"  Text="Save as Draft " CssClass="form-control" visible="false" class="btn btn-default saveDraftLdc" OnClick="btndraft_Click" />
                                                                        <asp:Button ID="btnApproval" runat="server"  Text="Send for Approval " CssClass="form-control" visible="false" class="btn btn-default saveApprovalLdc" OnClick="btnApproval_Click" />
